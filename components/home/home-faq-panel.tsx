...
const faqItems = [
  {
    ...
    a: "No. We publish ranked tables and guides for adults in the Republic of Ireland. You cannot wager, deposit, or withdraw through irishtopbetsites.com — every balance lives with the licensed operator you register with.",
  },
  {
  ...
  },
  {
    ...
    a: "We weight GAA coupons, Irish and UK racing cards, Premier League football, and in-play stability because those drive most Irish volume. Niche markets still matter if you bet them weekly — match the bookie to your fixture list.",
  },
  {
    q: "Where can I get help if betting feels out of control?",
    a: "Contact Gambling Care Ireland on 1800 936 725 for free, confidential support. Licensed sites must offer deposit limits, timeouts, and routes to the National Exclusion Register for multi-operator self-exclusion.",
  },
] as const
